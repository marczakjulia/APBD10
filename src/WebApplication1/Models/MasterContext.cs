...
public partial class MasterContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F6485A34C1").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E710699F15F").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E38F259E024").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D105346B2E7A0F").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F615ECAA54").IsUnique();
